...
bool ExampleLayer3::ProcessKey(Key key, InputState state, ModifierKey modifiers)
{
...
bool ExampleLayer3::ProcessMouse(int x, int y, InputState state, ModifierKey modifiers)
{
	if (state != InputState::kDown)
		return false;
